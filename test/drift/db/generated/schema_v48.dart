...
class Settings extends Table with TableInfo<Settings, SettingsData> {
  ...
  late final GeneratedColumn<int> scrollableTabs = GeneratedColumn<int>(
      ...
      defaultValue: const CustomExpression('1'));
  late final GeneratedColumn<int> statsPanel = GeneratedColumn<int>(
  ...
  SettingsData map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return SettingsData(
      ...
      statsPanel: attachedDatabase.typeMapping
          .read(DriftSqlType.int, data['${effectivePrefix}stats_panel'])!,
    );
  }
...
class SettingsData extends DataClass implements Insertable<SettingsData> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    map['stats_panel'] = Variable<int>(statsPanel);
    return map;
  }
  ...
  factory SettingsData.fromJson(Map<String, dynamic> json,
    ...
    return SettingsData(
      ...
      statsPanel: serializer.fromJson<int>(json['statsPanel']),
    );
  }
  @override
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      ...
      'statsPanel': serializer.toJson<int>(statsPanel),
    };
  }
...
class SettingsCompanion extends UpdateCompanion<SettingsData> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (statsPanel.present) {
      map['stats_panel'] = Variable<int>(statsPanel.value);
    }
    return map;
  }
